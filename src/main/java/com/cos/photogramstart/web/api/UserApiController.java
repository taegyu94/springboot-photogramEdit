...
public class UserApiController {
	...
	@GetMapping("/api/user/{pageUserId}/subscribe/{isFollower}")
	public ResponseEntity<?> subscribeList(@PathVariable int pageUserId, @AuthenticationPrincipal PrincipalDetalis principalDetalis,@PathVariable int isFollower){
		
		List<SubscribeDto> subscribeDto = subscribeService.구독리스트(principalDetalis.getUser().getId(),pageUserId,isFollower);
