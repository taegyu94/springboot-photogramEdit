		...
		<div class="profile-right">
			...
			<div class="subscribe">
				<ul>
					...
					<li><a href="javascript:subscribeInfoModalOpen(${dto.user.id},1);"> 팔로워<span id = "subscribeCount">${dto.followerCount}</span>
					</a></li>
					<li><a href="javascript:subscribeInfoModalOpen(${dto.user.id},0);"> 팔로잉<span id = "subscribeCount">${dto.followingCount}</span>
					</a></li>
				</ul>
			</div>
			<div class="state">
